...
import star.yx.interfaces.CommonInterfaceReqUtils;
import star.yx.interfaces.OnNetResponseListener;
    ...
    public NewBaseNet build() {
        try {
           // ExclusionStrategy excludeStrategy = new SetterExclusionStrategy(new String[]{"createTime", "lastUpdateTime", "birthday"});
            ExclusionStrategy excludeStrategy = new star.yx.utils.SetterExclusionStrategy(new String[]{"createTime", "lastUpdateTime", "birthday"});
