package star.yx.modul.view;

import android.graphics.Point;

import java.util.List;

import star.yx.utils.view.CommonUtil;
...
public class TreeMaker {
    ...
    public static void fillFallingBlooms(List<FallingBloom> blooms, int num) {
        ...
        while(n < num){
            ...
            float y = CommonUtil.random(-c, c);
            if (inHeart(x, y, r)) {
                blooms.add(new FallingBloom(new Point((int)x, -(int)y)));
                n++;
            }
        }
    }
    ...
    public static void fillBlooms(List<Bloom> blooms, int num) {
        ...
        while (n < num) {
            ...
            float y = CommonUtil.random(-c, c);
            if (inHeart(x, y, r)) {
                blooms.add(new Bloom(new Point((int)x, -(int)y)));
                n++;
            }
        }
    }
