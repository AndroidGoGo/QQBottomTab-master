...
import com.xujun.fragmenttabhostdemo.App;
import com.xujun.fragmenttabhostdemo.utils.NetUtil;
...
public class RetrofitService {
    ...
    private static void initOkHttpClient() {
        if (mOkHttpClient == null) {
            ...
            File cacheFile = new File(App.app.getCacheDir(), "HttpCache");//指定缓存路径
